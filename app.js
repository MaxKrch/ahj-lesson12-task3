...
;// CONCATENATED MODULE: ./src/js/ui/createNewsItem.js
...
;// CONCATENATED MODULE: ./src/js/ui/createNewsBlank.js
function createNewsBlank() {
...
class Render {
  ...
  renderWidget() {
    ...
    this.createMain();
    this.createModal();
    this.widget.container.append(this.widget.main.container, this.widget.modal.container);
  ...
  createMain() {
    ...
    this.widget.main.container.append(this.widget.main.update, this.widget.main.title, this.widget.main.newses);
  }
  createModal() {
    this.widget.modal.container = document.createElement(`aside`);
    this.widget.modal.container.classList.add(`modal`, `modal-container`, `hidden-item`);
    this.createModalNetworkError();
    this.widget.modal.container.append(this.widget.modal.networkError.container);
  }
  createMainUpdate() {
  ...
  createModalNetworkError() {
    this.widget.modal.networkError.container = document.createElement(`article`);
    this.widget.modal.networkError.container.classList.add(`modal-body`, `modal-network-error`, `hidden-item`);
    ...
    this.widget.modal.networkError.container.append(this.widget.modal.networkError.main.container, this.widget.modal.networkError.buttons.container);
  }
  createModalNetworkErrorMain() {
    this.widget.modal.networkError.main.container = document.createElement(`main`);
    this.widget.modal.networkError.main.container.classList.add(`modal-main`, `modal-network-error__main`);
    this.createModalNetworkErrorMainTitle();
    this.createModalNetworkErrorMainDescription();
    this.widget.modal.networkError.main.container.append(this.widget.modal.networkError.main.title, this.widget.modal.networkError.main.description);
  }
  createModalNetworkErrorButtons() {
    this.widget.modal.networkError.buttons.container = document.createElement(`div`);
    this.widget.modal.networkError.buttons.container.classList.add(`modal-buttons`, `modal-network-error__buttons`);
    this.createModalNetworkErrorButtonsConfirm();
    this.createModalNetworkErrorButtonsCancel();
    this.widget.modal.networkError.buttons.container.append(this.widget.modal.networkError.buttons.confirm, this.widget.modal.networkError.buttons.cancel);
  }
  createModalNetworkErrorMainTitle() {
    this.widget.modal.networkError.main.title = document.createElement(`h2`);
    this.widget.modal.networkError.main.title.classList.add(`modal-title`, `modal-network-error__title`);
    this.widget.modal.networkError.main.title.dataset.id = `ModalNetworkErrorTitle`;
    this.widget.modal.networkError.main.title.textContent = this.CONTENT.MODAL_NETWORK_ERROR_TITLE;
  }
  createModalNetworkErrorMainDescription() {
    this.widget.modal.networkError.main.description = document.createElement(`p`);
    this.widget.modal.networkError.main.description.classList.add(`modal-descr`, `modal-network-error__descr`);
    this.widget.modal.networkError.main.description.dataset.id = `ModalNetworkErrorDescr`;
    this.widget.modal.networkError.main.description.textContent = this.CONTENT.MODAL_NETWORK_ERROR_DESCR;
  }
  createModalNetworkErrorButtonsConfirm() {
    this.widget.modal.networkError.buttons.confirm = document.createElement(`button`);
    this.widget.modal.networkError.buttons.confirm.classList.add(`button`, `modal-button`, `modal-network-error__button`, `modal-network-error__button-confirm`);
    this.widget.modal.networkError.buttons.confirm.dataset.id = `modalNetworkErrorConfirm`;
    this.widget.modal.networkError.buttons.confirm.textContent = this.CONTENT.MODAL_NETWORK_ERROR_CONFIRM;
  }
  createModalNetworkErrorButtonsCancel() {
    this.widget.modal.networkError.buttons.cancel = document.createElement(`button`);
    this.widget.modal.networkError.buttons.cancel.classList.add(`button`, `modal-button`, `modal-network-error__button`, `modal-network-error__button-cancel`);
    this.widget.modal.networkError.buttons.cancel.dataset.id = `modalNetworkErrorCancel`;
    this.widget.modal.networkError.buttons.cancel.textContent = this.CONTENT.MODAL_NETWORK_ERROR_CANCEL;
  }
  ...
  createStreams() {
    this.streams.clicksToUpdateNews.stream$ = merge(fromEvent(this.widget.main.update, `click`), fromEvent(this.widget.modal.networkError.buttons.confirm, `click`)).pipe(throttleTime(250));
    this.streams.clicksToCloseNetworkError.stream$ = fromEvent(this.widget.modal.networkError.buttons.cancel, `click`).pipe(throttleTime(250));
    this.subscribeOnClicksCloseNetworkError(this.hideModalNetworkError.bind(this));
  }
...
class Connection {
  ...
  requestNews() {
    ...
    const request = ajax.getJSON(newsUrl).pipe(catchError(error => {
      return of({
        success: false,
        status: error.status
      });
...
;// CONCATENATED MODULE: ./src/js/state/State.js
...
;// CONCATENATED MODULE: ./src/js/api/WidgetNews.js
...
;// CONCATENATED MODULE: ./src/js/state/VARIABLE.js
const VARIABLE = {
  // SERVER_URL: `http://localhost:7070`,
  SERVER_URL: `https://ahj-lesson12-task3-backend.onrender.com`,
  APP_CONTAINER: `[data-id="app"]`,
  INIT_STATE: {},
  TEXT_CONTENT: {
    NEWS_FEED_UPDATE: `Обновить`,
    NEWS_FEED_TITLE: `Новости мира кино`,
    MODAL_NETWORK_ERROR_TITLE: `Не удалось загрузить новости`,
    MODAL_NETWORK_ERROR_DESCR: `Проверьте подключение к интернету и попробуйте обновить страницу`,
    MODAL_NETWORK_ERROR_CONFIRM: `Обновить`,
    MODAL_NETWORK_ERROR_CANCEL: `Закрыть`
  }
};
/* harmony default export */ const state_VARIABLE = (VARIABLE);
;// CONCATENATED MODULE: ./src/js/ui/askUserAboutUpdate.js

function askUserAboutUpdate(worker) {
...
const widgetNews = new WidgetNews(state_VARIABLE);
